...
public interface Controller {
   ...
   * jump (figure moved across another figure), only moves for the same figure can be performed,
   * ,the inverse jump (returning to jump origin) is not contained in the result set. If at least one
